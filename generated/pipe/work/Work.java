...
public final class Work {
  ...
  public interface WorkMessageOrBuilder extends
    ...
    /**
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
    boolean hasFileMessage();
    /**
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
    routing.FileTransfer.FileMsg getFileMessage();
    /**
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
    routing.FileTransfer.FileMsgOrBuilder getFileMessageOrBuilder();

    /**
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
    boolean hasRaftMessage();
    /**
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
    routing.FileTransfer.RaftMessage getRaftMessage();
    /**
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
    routing.FileTransfer.RaftMessageOrBuilder getRaftMessageOrBuilder();
  }
  /**
  ...
  public static final class WorkMessage extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106: {
              ...
              if (payloadCase_ == 13) {
                subBuilder = ((routing.FileTransfer.FileMsg) payload_).toBuilder();
              }
              payload_ = input.readMessage(routing.FileTransfer.FileMsg.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((routing.FileTransfer.FileMsg) payload_);
                payload_ = subBuilder.buildPartial();
              }
              payloadCase_ = 13;
              break;
            ...
            case 114: {
              routing.FileTransfer.RaftMessage.Builder subBuilder = null;
              if (payloadCase_ == 14) {
                subBuilder = ((routing.FileTransfer.RaftMessage) payload_).toBuilder();
              }
              payload_ = input.readMessage(routing.FileTransfer.RaftMessage.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((routing.FileTransfer.RaftMessage) payload_);
                payload_ = subBuilder.buildPartial();
              }
              payloadCase_ = 14;
              break;
    ...
    public enum PayloadCase
      ...
      public static PayloadCase valueOf(int value) {
        switch (value) {
          ...
          case 13: return FILEMESSAGE;
          case 14: return RAFTMESSAGE;
    ...
    public static final int FILEMESSAGE_FIELD_NUMBER = 13;
    /**
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
     ...
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
    public routing.FileTransfer.FileMsg getFileMessage() {
      if (payloadCase_ == 13) {
         return (routing.FileTransfer.FileMsg) payload_;
      }
     ...
     * <code>optional .FileMsg fileMessage = 13;</code>
     */
    public routing.FileTransfer.FileMsgOrBuilder getFileMessageOrBuilder() {
      if (payloadCase_ == 13) {
         return (routing.FileTransfer.FileMsg) payload_;
      }
      return routing.FileTransfer.FileMsg.getDefaultInstance();
    ...
    public static final int RAFTMESSAGE_FIELD_NUMBER = 14;
    /**
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
     ...
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
    public routing.FileTransfer.RaftMessage getRaftMessage() {
      if (payloadCase_ == 14) {
         return (routing.FileTransfer.RaftMessage) payload_;
      }
     ...
     * <code>optional .RaftMessage raftMessage = 14;</code>
     */
    public routing.FileTransfer.RaftMessageOrBuilder getRaftMessageOrBuilder() {
      if (payloadCase_ == 14) {
         return (routing.FileTransfer.RaftMessage) payload_;
      }
      return routing.FileTransfer.RaftMessage.getDefaultInstance();
    ...
    public final boolean isInitialized() {
      ...
      if (hasFileMessage()) {
        if (!getFileMessage().isInitialized()) {
          memoizedIsInitialized = 0;
          return false;
        }
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (payloadCase_ == 13) {
        output.writeMessage(13, (routing.FileTransfer.FileMsg) payload_);
      }
      if (payloadCase_ == 14) {
        output.writeMessage(14, (routing.FileTransfer.RaftMessage) payload_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (payloadCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (routing.FileTransfer.FileMsg) payload_);
      }
      if (payloadCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (routing.FileTransfer.RaftMessage) payload_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.SingleFieldBuilder<
          routing.FileTransfer.FileMsg, routing.FileTransfer.FileMsg.Builder, routing.FileTransfer.FileMsgOrBuilder> fileMessageBuilder_;
      /**
       * <code>optional .FileMsg fileMessage = 13;</code>
       */
      public boolean hasFileMessage() {
       ...
       * <code>optional .FileMsg fileMessage = 13;</code>
       */
      public Builder setFileMessage(routing.FileTransfer.FileMsg value) {
        if (fileMessageBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>optional .FileMsg fileMessage = 13;</code>
       */
      public Builder mergeFileMessage(routing.FileTransfer.FileMsg value) {
        if (fileMessageBuilder_ == null) {
          if (payloadCase_ == 13 &&
              payload_ != routing.FileTransfer.FileMsg.getDefaultInstance()) {
            payload_ = routing.FileTransfer.FileMsg.newBuilder((routing.FileTransfer.FileMsg) payload_)
                .mergeFrom(value).buildPartial();
          } else {
            payload_ = value;
          }
       ...
       * <code>optional .FileMsg fileMessage = 13;</code>
       */
      public routing.FileTransfer.FileMsg.Builder getFileMessageBuilder() {
       ...
       */
      public routing.FileTransfer.FileMsgOrBuilder getFileMessageOrBuilder() {
        if ((payloadCase_ == 13) && (fileMessageBuilder_ != null)) {
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (fileMessageBuilder_ == null) {
          ...
          fileMessageBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              routing.FileTransfer.FileMsg, routing.FileTransfer.FileMsg.Builder, routing.FileTransfer.FileMsgOrBuilder>(
                  (routing.FileTransfer.FileMsg) payload_,
                  getParentForChildren(),
                  isClean());
          payload_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          routing.FileTransfer.RaftMessage, routing.FileTransfer.RaftMessage.Builder, routing.FileTransfer.RaftMessageOrBuilder> raftMessageBuilder_;
      /**
       * <code>optional .RaftMessage raftMessage = 14;</code>
       */
      public boolean hasRaftMessage() {
       ...
       * <code>optional .RaftMessage raftMessage = 14;</code>
       */
      public Builder setRaftMessage(routing.FileTransfer.RaftMessage value) {
        if (raftMessageBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setRaftMessage(
          routing.FileTransfer.RaftMessage.Builder builderForValue) {
        if (raftMessageBuilder_ == null) {
          payload_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>optional .RaftMessage raftMessage = 14;</code>
       */
      public Builder mergeRaftMessage(routing.FileTransfer.RaftMessage value) {
        if (raftMessageBuilder_ == null) {
          if (payloadCase_ == 14 &&
              payload_ != routing.FileTransfer.RaftMessage.getDefaultInstance()) {
            payload_ = routing.FileTransfer.RaftMessage.newBuilder((routing.FileTransfer.RaftMessage) payload_)
                .mergeFrom(value).buildPartial();
          } else {
            payload_ = value;
          }
       ...
       * <code>optional .RaftMessage raftMessage = 14;</code>
       */
      public routing.FileTransfer.RaftMessage.Builder getRaftMessageBuilder() {
       ...
       */
      public routing.FileTransfer.RaftMessageOrBuilder getRaftMessageOrBuilder() {
        if ((payloadCase_ == 14) && (raftMessageBuilder_ != null)) {
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          routing.FileTransfer.RaftMessage, routing.FileTransfer.RaftMessage.Builder, routing.FileTransfer.RaftMessageOrBuilder> 
        ...
        if (raftMessageBuilder_ == null) {
          ...
          raftMessageBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              routing.FileTransfer.RaftMessage, routing.FileTransfer.RaftMessage.Builder, routing.FileTransfer.RaftMessageOrBuilder>(
                  (routing.FileTransfer.RaftMessage) payload_,
                  getParentForChildren(),
                  isClean());
          payload_ = null;
        }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\010 \001(\0132\r.LeaderStatusH\000\022#\n\013requestVote\030\t" +
      " \001(\0132\014.RequestVoteH\000\022#\n\013voteMessage\030\n \001(" +
      "\0132\014.VoteMessageH\000\022\'\n\rappendMessage\030\013 \001(\013" +
      "2\016.AppendMessageH\000\022#\n\013appendReply\030\014 \001(\0132" +
      "\014.AppendReplyH\000\022\037\n\013fileMessage\030\r \001(\0132\010.F",
      "ileMsgH\000\022#\n\013raftMessage\030\016 \001(\0132\014.RaftMess" +
      "ageH\000B\t\n\007payloadB\r\n\tpipe.workH\001"
    };
    ...
    internal_static_WorkMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_WorkMessage_descriptor,
        new java.lang.String[] { "Header", "Secret", "Err", "Ping", "Beat", "Task", "State", "Leader", "RequestVote", "VoteMessage", "AppendMessage", "AppendReply", "FileMessage", "RaftMessage", "Payload", });
    pipe.common.Common.getDescriptor();
    pipe.election.Election.getDescriptor();
    routing.FileTransfer.getDescriptor();
  }
