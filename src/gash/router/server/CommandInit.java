...
public class CommandInit extends ChannelInitializer<SocketChannel> {
	...
	public CommandInit(RoutingConf conf, boolean enableCompression, RaftManager mgr) {
		super();
		compress = enableCompression;
		this.conf = conf;
		this.thisManager = mgr;
	}
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("handler", new CommandHandler(conf, thisManager));
	}
}
